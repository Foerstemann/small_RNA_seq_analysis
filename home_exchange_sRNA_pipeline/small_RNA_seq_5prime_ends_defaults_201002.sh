...
for b in bowtie/*_"$mapping_loci".map; do
    ...
    perl /home/exchange/sRNA_pipeline/bin_5prime_individual_fasta_lines_plot_svg_190529.plx -ref:/home/exchange/bowtie/genomes/"$mapping_loci".fa -map:"$b" -bin:1 -norm:"$normvalue" >>sRNA_processing.log 2>>sRNA_processing.log
...
for b in bowtie/*_dmel-all-tRNA-r6.19.map; do
    ...
    echo "mapping reads on bases per fasta line">>sRNA_processing.log
    echo "mapping reads on bases per fasta line"
    perl /home/exchange/sRNA_pipeline/bin_5prime_individual_fasta_lines_plot_svg_190529.plx -ref:/home/exchange/bowtie/genomes/dmel-all-tRNA-r6.19.fa -map:"$b" -bin:1 -norm:"$normvalue" >>sRNA_processing.log 2>>sRNA_processing.log
...
for c in bowtie/*_dme_transposons.map; do
    ...
    echo "mapping reads on bases per fasta line">>sRNA_processing.log
    echo "mapping reads on bases per fasta line"
    perl /home/exchange/sRNA_pipeline/bin_5prime_individual_fasta_lines_plot_svg_190529.plx -ref:/home/exchange/bowtie/genomes/D_mel_transposon_sequence_cons_set_v941.fasta -map:"$c" -bin:1 -norm:"$normvalue" >>sRNA_processing.log  2>>sRNA_processing.log
...
for b in bowtie/*_dmel-all-ncRNA-r6.19.map; do
    ...
    echo "mapping reads on bases per fasta line">>sRNA_processing.log
    echo "mapping reads on bases per fasta line"
    perl /home/exchange/sRNA_pipeline/bin_5prime_individual_fasta_lines_plot_svg_190529.plx -ref:/home/exchange/bowtie/genomes/dmel-all-ncRNA-r6.19.fa -map:"$b" -bin:1 -norm:"$normvalue" >>sRNA_processing.log 2>>sRNA_processing.log
...
#    echo "mapping reads on bases per fasta line">>sRNA_processing.log
#    echo "mapping reads on bases per fasta line"
#    perl /home/exchange/sRNA_pipeline/bin_5prime_individual_fasta_lines_plot_svg_190529.plx -ref:/home/exchange/bowtie/genomes/dmel-all-intron-r6.19.fa -map:"$b" -bin:1 -norm:"$normvalue" >>sRNA_processing.log 2>>sRNA_processing.log
...
for b in bowtie/*_dmel-all-miscRNA-r6.19.map; do
    ...
    echo "mapping reads on bases per fasta line">>sRNA_processing.log
    echo "mapping reads on bases per fasta line"
    perl /home/exchange/sRNA_pipeline/bin_5prime_individual_fasta_lines_plot_svg_190529.plx -ref:/home/exchange/bowtie/genomes/dmel-all-miscRNA-r6.19.fa -map:"$b" -bin:1 -norm:"$normvalue" >>sRNA_processing.log 2>>sRNA_processing.log
