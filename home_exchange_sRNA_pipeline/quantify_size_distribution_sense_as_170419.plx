...
{ 
	...
	print OUTFILE "33 \t", $nt33_hash_s{$target_name[$z]},"\t", $nt33_hash_as{$target_name[$z]}, "\t", ($nt33_hash_s{$target_name[$z]}+$nt33_hash_as{$target_name[$z]}), "\n";
	print OUTFILE "34 \t", $nt34_hash_s{$target_name[$z]},"\t", $nt34_hash_as{$target_name[$z]}, "\t", ($nt34_hash_s{$target_name[$z]}+$nt34_hash_as{$target_name[$z]}), "\n";
	print OUTFILE "35 \t", $nt35_hash_s{$target_name[$z]},"\t", $nt35_hash_as{$target_name[$z]}, "\t", ($nt35_hash_s{$target_name[$z]}+$nt35_hash_as{$target_name[$z]}), "\n";
	print OUTFILE "36 \t", $nt36_hash_s{$target_name[$z]},"\t", $nt36_hash_as{$target_name[$z]}, "\t", ($nt36_hash_s{$target_name[$z]}+$nt36_hash_as{$target_name[$z]}), "\n";
	print OUTFILE "37 \t", $nt37_hash_s{$target_name[$z]},"\t", $nt37_hash_as{$target_name[$z]}, "\t", ($nt37_hash_s{$target_name[$z]}+$nt37_hash_as{$target_name[$z]}), "\n";
	print OUTFILE "38 \t", $nt38_hash_s{$target_name[$z]},"\t", $nt38_hash_as{$target_name[$z]}, "\t", ($nt38_hash_s{$target_name[$z]}+$nt38_hash_as{$target_name[$z]}), "\n";
	print OUTFILE "39 \t", $nt39_hash_s{$target_name[$z]},"\t", $nt39_hash_as{$target_name[$z]}, "\t", ($nt39_hash_s{$target_name[$z]}+$nt39_hash_as{$target_name[$z]}), "\n";
	print OUTFILE "40 \t", $nt40_hash_s{$target_name[$z]},"\t", $nt40_hash_as{$target_name[$z]}, "\t", ($nt40_hash_s{$target_name[$z]}+$nt40_hash_as{$target_name[$z]}), "\n";
...
{ 
	...
	print "33 \t", $nt33_hash_s{$target_name[$z]},"\t", $nt33_hash_as{$target_name[$z]}, "\t", ($nt33_hash_s{$target_name[$z]}+$nt33_hash_as{$target_name[$z]}), "\n";
	print "34 \t", $nt34_hash_s{$target_name[$z]},"\t", $nt34_hash_as{$target_name[$z]}, "\t", ($nt34_hash_s{$target_name[$z]}+$nt34_hash_as{$target_name[$z]}), "\n";
	print "35 \t", $nt35_hash_s{$target_name[$z]},"\t", $nt35_hash_as{$target_name[$z]}, "\t", ($nt35_hash_s{$target_name[$z]}+$nt35_hash_as{$target_name[$z]}), "\n";
	print "36 \t", $nt36_hash_s{$target_name[$z]},"\t", $nt36_hash_as{$target_name[$z]}, "\t", ($nt36_hash_s{$target_name[$z]}+$nt36_hash_as{$target_name[$z]}), "\n";
	print "37 \t", $nt37_hash_s{$target_name[$z]},"\t", $nt37_hash_as{$target_name[$z]}, "\t", ($nt37_hash_s{$target_name[$z]}+$nt37_hash_as{$target_name[$z]}), "\n";
	print "38 \t", $nt38_hash_s{$target_name[$z]},"\t", $nt38_hash_as{$target_name[$z]}, "\t", ($nt38_hash_s{$target_name[$z]}+$nt38_hash_as{$target_name[$z]}), "\n";
	print "39 \t", $nt39_hash_s{$target_name[$z]},"\t", $nt39_hash_as{$target_name[$z]}, "\t", ($nt39_hash_s{$target_name[$z]}+$nt39_hash_as{$target_name[$z]}), "\n";
	print "40 \t", $nt40_hash_s{$target_name[$z]},"\t", $nt40_hash_as{$target_name[$z]}, "\t", ($nt40_hash_s{$target_name[$z]}+$nt40_hash_as{$target_name[$z]}), "\n";
